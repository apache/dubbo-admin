...
const words: I18nType = {
  ...
  ruleVersionDomain: {
    ...
    rollbackHistoryRecordFailed: 'Rollback took effect, but rollback history was not recorded',
    rollbackFailed: 'Rollback failed',
    diffFailed: 'Failed to load version diff',
    rollbackLatestRecordedDisabled: 'Latest recorded version does not need rollback',
