...
const words: I18nType = {
  ...
  ruleVersionDomain: {
    ...
    current: '当前',
    currentVersion: '当前版本',
    currentDeleted: '当前已删除',
    targetVersion: '目标版本',
    versionConflict: '版本冲突',
    versionConflictDescription: '规则已被其他操作更新，请重新加载当前版本后再提交。',
    ledgerPending: '版本账本待恢复',
    ...
    rollbackCasHint: '如果当前版本已变化，后端会拒绝本次回滚，请刷新后重试。',
    ...
    rollbackConflict: '版本冲突：当前规则已被其他人修改，请刷新后重试',
    rollbackPending: '当前规则存在未完成的版本 intent，请先修复或放弃后再重试',
    rollbackFailed: '回滚失败',
    diffFailed: '加载版本差异失败',
    rollbackCurrentDisabled: '当前版本无需回滚',
    ...
    reload: '重新加载',
    repair: '修复',
    repairFailed: '修复 intent 失败',
    abandon: '放弃',
    cancel: '取消',
    abandonIntentTitle: '放弃版本 intent',
    abandonReasonPlaceholder: '请输入放弃原因（必填）',
    abandonReasonRequired: '请输入放弃原因',
    abandonFailed: '放弃 intent 失败'
  },
  backHome: '回到首页',
