...
import type { ServiceDistributionItem } from '@/types/api'

const distributionList: ServiceDistributionItem[] = [
  {
...
export const serviceDistributionHandlers: HttpHandler[] = [
  http.get(`${base}/service/distribution`, () =>
    success({
      total: 8,
      curPage: 1,
      pageSize: 1,
