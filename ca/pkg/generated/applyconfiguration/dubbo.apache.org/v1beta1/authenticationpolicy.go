...
// AuthenticationPolicyApplyConfiguration represents an declarative configuration of the AuthenticationPolicy type for use
// with apply.
...
// AuthenticationPolicy constructs an declarative configuration of the AuthenticationPolicy type for use with
// apply.
func AuthenticationPolicy(name, namespace string) *AuthenticationPolicyApplyConfiguration {
	b := &AuthenticationPolicyApplyConfiguration{}
	b.WithName(name)
	b.WithNamespace(namespace)
	b.WithKind("AuthenticationPolicy")
...
func (b *AuthenticationPolicyApplyConfiguration) ensureObjectMetaApplyConfigurationExists() {
