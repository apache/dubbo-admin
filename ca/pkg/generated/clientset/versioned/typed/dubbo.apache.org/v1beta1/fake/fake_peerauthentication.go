...
func (c *FakePeerAuthentications) Apply(ctx context.Context, peerAuthentication *dubboapacheorgv1beta1.PeerAuthenticationApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.PeerAuthentication, err error) {
