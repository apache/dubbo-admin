...
type PeerAuthenticationInterface interface {
	...
	Apply(ctx context.Context, peerAuthentication *dubboapacheorgv1beta1.PeerAuthenticationApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.PeerAuthentication, err error)
...
func newPeerAuthentications(c *DubboV1beta1Client, namespace string) *peerAuthentications {
...
func (c *peerAuthentications) Apply(ctx context.Context, peerAuthentication *dubboapacheorgv1beta1.PeerAuthenticationApplyConfiguration, opts v1.ApplyOptions) (result *v1beta1.PeerAuthentication, err error) {
