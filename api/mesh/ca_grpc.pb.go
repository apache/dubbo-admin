...
// AuthorityServiceClient is the clientgen API for AuthorityService service.
//
...
// AuthorityServiceServer is the cp-server API for AuthorityService service.
...
// RuleServiceClient is the clientgen API for RuleService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
