import{y as C,_ as I}from"./js-yaml-vkt1gEZY.js";import{d as D,y as $,z as L,u as O,B as h,D as Y,H as x,J as v,w as e,e as s,o as b,b as t,f as a,n as k,ab as M,ac as P,j as o,T as U,m as w,p as H,h as j,_ as z}from"./index-dFnkDtr3.js";import{a as J}from"./traffic-DOTqHdcc.js";import{H as K}from"./request-XCHrvkfl.js";const c=p=>(H("data-v-93e60661"),p=p(),j(),p),q={class:"editorBox"},F={class:"bottom-action-footer"},G=c(()=>o("br",null,null,-1)),Q=c(()=>o("br",null,null,-1)),W=c(()=>o("br",null,null,-1)),X=c(()=>o("br",null,null,-1)),Z=c(()=>o("br",null,null,-1)),ee=c(()=>o("br",null,null,-1)),te=D({__name:"addByYAMLView",setup(p){const d=$(L.TAB_LAYOUT_STATE),A=O(),B=h(!1),r=h(!1),R=h(8),i=h(`conditions:
  - from:
      match: >-
