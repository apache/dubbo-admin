import{y as b,_ as w}from"./js-yaml-qLFgkzx1.js";import{e as C}from"./traffic-o8WnxYxr.js";import{d as D,a as T,B as d,D as B,J as r,w as e,e as u,o as l,b as a,f,t as L,n as x,aa as R,ab as A,j as p,c as I,M,L as N,T as O,p as Y,h as $,_ as j}from"./index-qjZKaUiH.js";import{H as E}from"./request-uaishOaO.js";const h=n=>(Y("data-v-f2b8fdfe"),n=n(),$(),n),H={class:"editorBox"},P=h(()=>p("p",null,"修改时间: 2024/3/20 15:20:31",-1)),U=h(()=>p("p",null,"版本号: xo842xqpx834",-1)),q=D({__name:"YAMLView",setup(n){const k=T(),S=d(!0),t=d(!1),m=d(8),y=d(`configVersion: v3.0
force: true
enabled: true
key: shop-detail
tags:
