import{y as C,_ as I}from"./js-yaml-YwaVfrOm.js";import{d as D,y as $,z as L,u as O,B as h,D as Y,H as x,J as v,w as e,e as s,o as b,b as t,f as a,n as k,ac as M,ad as P,j as o,T as U,m as w,p as H,h as j,_ as z}from"./index-Lne4X5cE.js";import{a as J}from"./traffic-rx8lt-dC.js";import{H as K}from"./request-oNRuPKOr.js";const d=p=>(H("data-v-93e60661"),p=p(),j(),p),q={class:"editorBox"},F={class:"bottom-action-footer"},G=d(()=>o("br",null,null,-1)),Q=d(()=>o("br",null,null,-1)),W=d(()=>o("br",null,null,-1)),X=d(()=>o("br",null,null,-1)),Z=d(()=>o("br",null,null,-1)),ee=d(()=>o("br",null,null,-1)),te=D({__name:"addByYAMLView",setup(p){const c=$(L.TAB_LAYOUT_STATE),A=O(),B=h(!1),r=h(!1),R=h(8),i=h(`conditions:
  - from:
      match: >-
