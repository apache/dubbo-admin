import{y as k,_ as w}from"./js-yaml-vkt1gEZY.js";import{e as T}from"./traffic-DOTqHdcc.js";import{d as B,a as b,B as s,D as C,J as y,w as e,e as n,o as u,b as a,j as _,c as A,M as I,f as v,L,T as M,p as N,h as D,_ as R}from"./index-dFnkDtr3.js";import{H as Y}from"./request-XCHrvkfl.js";const x=o=>(N("data-v-cdabac6c"),o=o(),D(),o),j={class:"editorBox"},E=x(()=>_("p",null,"修改时间: 2024/3/20 15:20:31",-1)),H=x(()=>_("p",null,"版本号: xo842xqpx834",-1)),P=B({__name:"YAMLView",setup(o){const h=b(),g=s(!0),l=s(!1),p=s(8),i=s(`configVersion: v3.0
force: true
enabled: true
key: shop-detail
tags:
