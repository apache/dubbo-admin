...
func NewSnp(config *dubbo_cp.Config, kubeClient *versioned.Clientset) *Snp {
	return &Snp{
...
func getOrCreateSnp(kubeClient *versioned.Clientset, namespace string, interfaceName string, newApps []string) (*apisv1alpha1.ServiceNameMapping, bool, error) {
	ctx := context.TODO()
...
func tryRegister(kubeClient *versioned.Clientset, namespace, interfaceName string, newApps []string) error {
