...
import (
	"context"
	v1alpha1 "github.com/apache/dubbo-admin/pkg/mapping/apis/dubbo.apache.org/v1alpha1"
...
var servicenamemappingsResource = v1alpha1.SchemeGroupVersion.WithResource("servicenamemappings")

var servicenamemappingsKind = v1alpha1.SchemeGroupVersion.WithKind("ServiceNameMapping")
