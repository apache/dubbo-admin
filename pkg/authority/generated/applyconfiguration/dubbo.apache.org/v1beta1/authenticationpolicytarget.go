...
// AuthenticationPolicyTargetApplyConfiguration represents an declarative configuration of the AuthenticationPolicyTarget type for use
// with apply.
type AuthenticationPolicyTargetApplyConfiguration struct {
...
// AuthenticationPolicyTargetApplyConfiguration constructs an declarative configuration of the AuthenticationPolicyTarget type for use with
// apply.
func AuthenticationPolicyTarget() *AuthenticationPolicyTargetApplyConfiguration {
	return &AuthenticationPolicyTargetApplyConfiguration{}
}
...
func (b *AuthenticationPolicyTargetApplyConfiguration) WithIpBlocks(values ...string) *AuthenticationPolicyTargetApplyConfiguration {
	for i := range values {
...
func (b *AuthenticationPolicyTargetApplyConfiguration) WithNotIpBlocks(values ...string) *AuthenticationPolicyTargetApplyConfiguration {
	for i := range values {
...
func (b *AuthenticationPolicyTargetApplyConfiguration) WithPrincipals(values ...string) *AuthenticationPolicyTargetApplyConfiguration {
	for i := range values {
...
func (b *AuthenticationPolicyTargetApplyConfiguration) WithNotPrincipals(values ...string) *AuthenticationPolicyTargetApplyConfiguration {
	for i := range values {
...
func (b *AuthenticationPolicyTargetApplyConfiguration) WithExtends(values ...*AuthenticationPolicyExtendApplyConfiguration) *AuthenticationPolicyTargetApplyConfiguration {
	for i := range values {
		if values[i] == nil {
...
func (b *AuthenticationPolicyTargetApplyConfiguration) WithNotExtends(values ...*AuthenticationPolicyExtendApplyConfiguration) *AuthenticationPolicyTargetApplyConfiguration {
	for i := range values {
		if values[i] == nil {
