...
func TestAdd(t *testing.T) {
	...
	policies := make(map[string]*authentication.Policy, 1000)

	for i := 0; i < 1000; i++ {
		policies["test"+strconv.Itoa(i)] = &authentication.Policy{
...
func TestDelete(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		handler.Add("test"+strconv.Itoa(i), &authentication.Policy{
			Name: "test" + strconv.Itoa(i),
		})
	}
