...
type ConditionRouteSpec struct {
	...
	ConditionRoute model.ConditionRoute `json:"ConditionRoute"`
}

// ConditionRouteStatus defines the observed state of ConditionRoute
...
type ConditionRoute struct {
	...
	Spec   ConditionRouteSpec   `json:"spec,omitempty"`
