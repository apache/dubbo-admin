...
func (r *ApplicationResource) DeepCopyObject() k8sruntime.Object {
	...
	if r.Spec != nil {
		out.Spec = proto.Clone(r.Spec).(*meshproto.Application)
	}

	return out
}

func NewApplicationResourceWithAttributes(name string, mesh string, apiVersion string) *ApplicationResource {
