	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DubboV1beta1().TagRoutes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DubboV1beta1().TagRoutes(namespace).Watch(context.TODO(), options)
			},
		},
		&dubboapacheorgv1beta1.TagRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *tagRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dubboapacheorgv1beta1.TagRoute{}, f.defaultInformer)
}

func (f *tagRouteInformer) Lister() v1beta1.TagRouteLister {
	return v1beta1.NewTagRouteLister(f.Informer().GetIndexer())
}
