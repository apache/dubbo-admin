...
type DynamicConfigInformer interface {
	...
	Lister() v1beta1.DynamicConfigLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DubboV1beta1().DynamicConfigs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DubboV1beta1().DynamicConfigs(namespace).Watch(context.TODO(), options)
			},
		},
		&dubboapacheorgv1beta1.DynamicConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *dynamicConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dubboapacheorgv1beta1.DynamicConfig{}, f.defaultInformer)
}

func (f *dynamicConfigInformer) Lister() v1beta1.DynamicConfigLister {
	return v1beta1.NewDynamicConfigLister(f.Informer().GetIndexer())
}
