	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DubboV1beta1().ServiceNameMappings(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DubboV1beta1().ServiceNameMappings(namespace).Watch(context.TODO(), options)
			},
		},
		&dubboapacheorgv1beta1.ServiceNameMapping{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceNameMappingInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dubboapacheorgv1beta1.ServiceNameMapping{}, f.defaultInformer)
}
