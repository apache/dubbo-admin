...
type ConditionRouteInformer interface {
	...
	Lister() v1beta1.ConditionRouteLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DubboV1beta1().ConditionRoutes(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DubboV1beta1().ConditionRoutes(namespace).Watch(context.TODO(), options)
			},
		},
		&dubboapacheorgv1beta1.ConditionRoute{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *conditionRouteInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dubboapacheorgv1beta1.ConditionRoute{}, f.defaultInformer)
}

func (f *conditionRouteInformer) Lister() v1beta1.ConditionRouteLister {
	return v1beta1.NewConditionRouteLister(f.Informer().GetIndexer())
}
