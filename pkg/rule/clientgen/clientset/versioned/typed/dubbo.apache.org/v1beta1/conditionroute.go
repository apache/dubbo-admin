...
type ConditionRouteInterface interface {
	Create(ctx context.Context, conditionRoute *v1beta1.ConditionRoute, opts v1.CreateOptions) (*v1beta1.ConditionRoute, error)
	Update(ctx context.Context, conditionRoute *v1beta1.ConditionRoute, opts v1.UpdateOptions) (*v1beta1.ConditionRoute, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.ConditionRoute, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.ConditionRouteList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ConditionRoute, err error)
...
func newConditionRoutes(c *DubboV1beta1Client, namespace string) *conditionRoutes {
...
func (c *conditionRoutes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.ConditionRoute, err error) {
	result = &v1beta1.ConditionRoute{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *conditionRoutes) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ConditionRouteList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ConditionRouteList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("conditionroutes").
...
func (c *conditionRoutes) Create(ctx context.Context, conditionRoute *v1beta1.ConditionRoute, opts v1.CreateOptions) (result *v1beta1.ConditionRoute, err error) {
	result = &v1beta1.ConditionRoute{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("conditionroutes").
...
func (c *conditionRoutes) Update(ctx context.Context, conditionRoute *v1beta1.ConditionRoute, opts v1.UpdateOptions) (result *v1beta1.ConditionRoute, err error) {
	result = &v1beta1.ConditionRoute{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("conditionroutes").
...
func (c *conditionRoutes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.ConditionRoute, err error) {
	result = &v1beta1.ConditionRoute{}
