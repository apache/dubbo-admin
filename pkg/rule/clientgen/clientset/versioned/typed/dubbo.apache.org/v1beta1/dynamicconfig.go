...
type DynamicConfigInterface interface {
	Create(ctx context.Context, dynamicConfig *v1beta1.DynamicConfig, opts v1.CreateOptions) (*v1beta1.DynamicConfig, error)
	Update(ctx context.Context, dynamicConfig *v1beta1.DynamicConfig, opts v1.UpdateOptions) (*v1beta1.DynamicConfig, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.DynamicConfig, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.DynamicConfigList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.DynamicConfig, err error)
...
func newDynamicConfigs(c *DubboV1beta1Client, namespace string) *dynamicConfigs {
...
func (c *dynamicConfigs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.DynamicConfig, err error) {
	result = &v1beta1.DynamicConfig{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *dynamicConfigs) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.DynamicConfigList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.DynamicConfigList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("dynamicconfigs").
...
func (c *dynamicConfigs) Create(ctx context.Context, dynamicConfig *v1beta1.DynamicConfig, opts v1.CreateOptions) (result *v1beta1.DynamicConfig, err error) {
	result = &v1beta1.DynamicConfig{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("dynamicconfigs").
...
func (c *dynamicConfigs) Update(ctx context.Context, dynamicConfig *v1beta1.DynamicConfig, opts v1.UpdateOptions) (result *v1beta1.DynamicConfig, err error) {
	result = &v1beta1.DynamicConfig{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("dynamicconfigs").
...
func (c *dynamicConfigs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.DynamicConfig, err error) {
	result = &v1beta1.DynamicConfig{}
