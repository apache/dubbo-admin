...
func TestAdd(t *testing.T) {
	...
	handler := dynamicconfig.NewHandler(storages)
	...
	policies := make(map[string]*dynamicconfig.Policy, 1000)

	for i := 0; i < 1000; i++ {
		policies["test"+strconv.Itoa(i)] = &dynamicconfig.Policy{
...
func TestDelete(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		handler.Add("test"+strconv.Itoa(i), &dynamicconfig.Policy{
			Name: "test" + strconv.Itoa(i),
		})
	}
