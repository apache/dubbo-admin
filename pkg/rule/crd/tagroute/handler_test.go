...
func TestAdd(t *testing.T) {
	...
	handler := tagroute.NewHandler(storages)
	...
	policies := make(map[string]*tagroute.Policy, 1000)

	for i := 0; i < 1000; i++ {
		policies["test"+strconv.Itoa(i)] = &tagroute.Policy{
...
func TestDelete(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		handler.Add("test"+strconv.Itoa(i), &tagroute.Policy{
			Name: "test" + strconv.Itoa(i),
		})
	}
