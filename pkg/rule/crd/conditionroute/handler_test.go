...
func TestAdd(t *testing.T) {
	...
	handler := conditionroute.NewHandler(storages)
	...
	policies := make(map[string]*conditionroute.Policy, 1000)

	for i := 0; i < 1000; i++ {
		policies["test"+strconv.Itoa(i)] = &conditionroute.Policy{
...
func TestDelete(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		handler.Add("test"+strconv.Itoa(i), &conditionroute.Policy{
			Name: "test" + strconv.Itoa(i),
		})
	}
