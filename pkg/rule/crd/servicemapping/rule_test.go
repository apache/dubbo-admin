...
func TestRule(t *testing.T) {
	...
	originRule := storages.LatestRules[storage.ServiceMapping]

	if originRule == nil {
		t.Error("expected origin rule to be added")
	}

	if originRule.Type() != storage.ServiceMapping {
	...
	if toClient.Type() != storage.ServiceMapping {
