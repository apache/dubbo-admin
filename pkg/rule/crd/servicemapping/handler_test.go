...
func TestAdd(t *testing.T) {
	...
	handler := servicemapping.NewHandler(storages)
	...
	policies := make(map[string]*servicemapping.Policy, 1000)

	for i := 0; i < 1000; i++ {
		policies["test"+strconv.Itoa(i)] = &servicemapping.Policy{
...
func TestDelete(t *testing.T) {
	...
	for i := 0; i < 1000; i++ {
		handler.Add("test"+strconv.Itoa(i), &servicemapping.Policy{
			Name: "test" + strconv.Itoa(i),
		})
	}
