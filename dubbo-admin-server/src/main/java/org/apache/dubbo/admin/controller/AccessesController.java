...
public class AccessesController {
    ...
    public List<AccessDTO> searchAccess(HttpServlet httpServlet, @RequestParam(required = false) String service,
        ...
        while (iterator.hasNext()) {
            ...
            AccessDTO dto = accessesAuthentication.authentication(httpServlet, service, application, env, serviceVersion, serviceGroup);
            AccessDTO accessDTO;
